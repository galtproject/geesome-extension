...
this.singlefile.extension.ui.content.infobar =
  ...
  (() => {
    ...
    function hideInfobar(infobarElement, linkElement, infoElement) {
      ...
      infobarElement.style.setProperty('opacity', 0.7);
      infobarElement.onmouseout = () => infobarElement.style.setProperty('opacity', 0.7);
