...
this.singlefile.lib.modules.fontsAltMinifier =
  this.singlefile.lib.modules.fontsAltMinifier ||
  (() => {
      ...
      fontsDetails.fonts.forEach((fontInfo, fontKey) => {
        fontsDetails.fonts.set(
          ...
          fontInfo.map(fontSource => {
            ...
            let fontFormat;
            const urlMatch = fontSource.match(REGEXP_URL_SIMPLE_QUOTES_FN) || fontSource.match(REGEXP_URL_DOUBLE_QUOTES_FN) || fontSource.match(REGEXP_URL_NO_QUOTES_FN);
