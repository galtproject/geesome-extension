...
this.singlefile.lib.vendor.fontPropertyParser =
  this.singlefile.lib.vendor.fontPropertyParser ||
  (() => {
    ...
    const cssFontSizeKeywords = ['xx-small', 'x-small', 'small', 'medium', 'large', 'x-large', 'xx-large', 'larger', 'smaller'];
    ...
    function isSize(value) {
      return !isNaN(parseFloat(value)) || value.indexOf('/') !== -1 || cssFontSizeKeywords.indexOf(value) !== -1;
    }
